...
celery -A app.core.celery_app:celery_app worker -n orch-worker-legacy@%h -Q ${DISPATCH_QUEUE},${EXECUTE_QUEUE},${HEARTBEAT_QUEUE} --without-mingle --without-gossip -l INFO"
