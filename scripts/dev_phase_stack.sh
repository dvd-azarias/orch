...
CELERY_DISPATCH_QUEUE=${DISPATCH_QUEUE} CELERY_EXECUTE_QUEUE=${EXECUTE_QUEUE} CELERY_SWITCH_BOT_FLOW_QUEUE=${SWITCH_BOT_FLOW_QUEUE} CELERY_DIALER_SUPPLIER_V2_QUEUE=${DIALER_SUPPLIER_V2_QUEUE} CELERY_CHANNEL_SUPPLIER_V2_QUEUE=${CHANNEL_SUPPLIER_V2_QUEUE} CELERY_HEARTBEAT_QUEUE=${HEARTBEAT_QUEUE} \
...
celery -A app.core.celery_app:celery_app worker --hostname=orch-celery-worker@_macbook_deivid_dev -n orch-worker-legacy@%h -Q ${DISPATCH_QUEUE},${EXECUTE_QUEUE},${SWITCH_BOT_FLOW_QUEUE},${DIALER_SUPPLIER_V2_QUEUE},${CHANNEL_SUPPLIER_V2_QUEUE},${HEARTBEAT_QUEUE} --without-mingle --without-gossip -l INFO"
