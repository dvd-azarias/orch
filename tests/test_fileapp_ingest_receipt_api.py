...
async def test_tipo1_replay_does_not_enqueue_again(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr(orch_api, "claim_fileapp_ingest_receipt", AsyncMock(return_value={"id": 19, "status": "enqueued", "task_id": "93e65e1a-7461-48f0-91d5-33ba27491f54", "created": False}))
