...
- `send_with_dialer_handoff`: preserva o marcador Dialer e acrescenta destino pós-atendimento BOT ou humano; a tabulação posterior continua pelo `wait_for_event` genérico, sem alterar o card Dialer legado.
