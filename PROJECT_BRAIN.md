...
- `docs/project-knowledge/ORCHESTRATION_JOURNEY_METRICS_WS_CONTRACT.md` — proposta `0.2-draft` snapshot-only do contrato ORCH -> Metrics, incluindo transporte SYNC, latest-state delivery, retencao, funil, saude, canais, privacidade e as cinco confirmacoes pendentes de envelope/sala, tamanho/compressao, rate limit, ACK observacional e aceite do schema; fixture em `ORCHESTRATION_JOURNEY_METRICS_WS_EXAMPLES.json`.
